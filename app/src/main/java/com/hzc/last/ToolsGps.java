...
public class ToolsGps {
    ...
    public static void main(String[] a) {
        double[][] xy = new double[][]{
                new double[]{103.2820, 29.2848},
                new double[]{103.3020, 29.3523},
                new double[]{103.1346, 29.2221}
        };
        for (double[] dou : xy) {
            double[] doubles = gcj02_To_Bd09(dou[0], dou[1]);
            System.out.println(Arrays.toString(doubles));
        }
        System.out.println("gcj02_To_Gps84");
        xy = new double[][]{
                new double[]{103.2820, 29.2848},
                new double[]{103.3020, 29.3523},
                new double[]{103.1346, 29.2221}
        ...
        for (double[] dou : xy) {
            double[] doubles = bd09_To_gps84(dou[0], dou[1]);
            System.out.println(Arrays.toString(doubles));
        }
    }
